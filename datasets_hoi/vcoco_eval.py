...
class VCOCOEvaluator():
    ...
    def __init__(self, preds, gts, subject_category_id, correct_mat, use_nms=True, nms_thresh=0.5, nms_alpha=1, nms_beta=0.5):
        ...
        self.gts = []
        print("loading gts")
        for img_gts in tqdm(gts, disable= not utils.is_main_process()):
