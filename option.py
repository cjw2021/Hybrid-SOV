...
class Options:
    def get_args_parser():
        ...
        # dataset parameters
        parser.add_argument('--dataset_file', default='hico',choices=['hico', 'vcoco', 'vcoco_self_object'], help='dataset file')
        ...
        ###########################################################################
        # DAB
        parser.add_argument('--no_fix_clip_linear', action='store_true', help="")
        ...
        # loss
        parser.add_argument('--hoi_loss_coef', default=1.0, type=float)
